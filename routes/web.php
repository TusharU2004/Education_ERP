...
Route::group(['middleware' => 'auth'], function () {
   ...
   Route::prefix('students')->group(function () {
      ...
      Route::get('attendance/student/view',[StudentAttendanceController::class,'AttendanceView'])->name('student.attendance.view');
   ...
   Route::prefix('marks')->group(function () {
      ...
      Route::get('marks/classwise',[MarksController::class,'MarksView'])->name('marks.entry.view');
      // Marks Entry Grade 

                     ...
                     <table id="example1" class="table table-bordered table-striped">
                        ...
                        <tbody>
                           ...
                           <tr>
                              ...
                              <td> {{ $shift->name }}</td>
                              <td>
                                 <a href="{{ route('student.shift.edit', $shift->id) }}" class="btn btn-info btn-sm">Edit</a>
                                 <a href="{{ route('student.shift.delete', $shift->id) }}" class="btn btn-danger btn-sm" id="delete">Delete</a>
                              </td>
                           </tr>
                           @endforeach
                        </tbody>

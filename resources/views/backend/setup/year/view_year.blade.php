                           ...
                           <table id="example1" class="table table-bordered table-striped">
                              ...
                              @foreach($allData as $key => $year)
                                 <tr>
                                    ...
                                    <td> {{ $year->name }}</td>
                                    <td>
                                       <a href="{{ route('student.year.edit', $year->id) }}" class="btn btn-info btn-sm">Edit</a>
                                       <a href="{{ route('student.year.delete', $year->id) }}" class="btn btn-danger btn-sm"id="delete">Delete</a>
                                    </td>
                                 </tr>
                              @endforeach
                              </tbody>
